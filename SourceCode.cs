...
namespace WindowsFormsApplication7
{
    public partial class Form1 : Form
    {
        ...
        {
            kn();
            cmd = new SqlCommand("select * from Sodobandan ", conn);
            dt = new DataTable();
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            dt = new DataTable();
            dt.Load(dr);
            cmd.CommandText = "Update Sodobandan set SoLuong='" + soluong.Text + "', DonGia='" + dongia.Text + "' where TenBan='" + comboBox1.SelectedValue + "'and TenMon='"+comboBox2.SelectedValue+"'";
        ...
        {
            int dong = e.RowIndex;
            soluong.Text = dataGridView.Rows[dong].Cells[2].Value.ToString();
            dongia.Text = dataGridView.Rows[dong].Cells[3].Value.ToString();
            comboBox1.Text = dataGridView.Rows[dong].Cells[0].Value.ToString();
            comboBox2.Text = dataGridView.Rows[dong].Cells[1].Value.ToString();
        }
